...
class C_dosbing extends CI_Controller {
    ...
    //  method yang akan diakses saat controller ini diakses
        ...
        $this->load->view('admin/v_dosbing', $data);
        ...
        $data['dosbing'] = $this->m_data->tampil_data()->result();
            ...
            $this->load->view('templates/sidebar',$data);
            $this->load->view('templates/topbar',$data);
            $this->load->view('admin/v_inputdosbing',$data);
            $this->load->view('templates/footer');
        }
        ...
        function tambah_dosbing(){
          ...
          function edit($id){
            ...
            $this->load->view('templates/sidebar',$data);
            $this->load->view('templates/topbar',$data);
            $this->load->view('admin/v_editdosbing',$data);
            $this->load->view('templates/footer');
