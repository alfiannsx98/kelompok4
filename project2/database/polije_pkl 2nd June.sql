...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2020 at 08:33 AM
...
('M0007', 'IDPR02', 'E41181336', 'diiidin', NULL, NULL, NULL, NULL, 1),
...
('PND-E41181', 'PR0001', 'DS001', 'Februari, 2020', 'Adocx'),
...
--
-- Stand-in structure for view `view_daftar_pkl`
...
--
-- Stand-in structure for view `view_kelompok`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `view_tampil_detail`
-- (See below for the actual view)
--
...
--
-- Structure for view `view_daftar_pkl`
--
...
--
-- Structure for view `view_kelompok`
--
...
--
-- Structure for view `view_tampil_detail`
--
...
ALTER TABLE `mhs_rating`
  ...
  ADD KEY `ID_RT` (`ID_RT`,`ID_PR`,`ID_M`) USING BTREE;
