                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group label-floating">
                                        ...
                                        <label type="email" class="form-control" value=""><?= $user['JK_ADM']; ?></label>
                                        <?= form_error('email', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group label-floating">
                                        ...
                                        <label class="form-control" name="about" id="about"><?= $user['PRODI_ADM']; ?></label>
                                        <?= form_error('nama', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group label-floating">
                                        ...
                                        <label type="email" class="form-control" value=""><?= $user['HP_ADM']; ?></label>
                                        <?= form_error('email', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </div>
                                </div>
                            </div>
