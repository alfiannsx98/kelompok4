			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						...
						<div class="row">
							<label class="col-sm-2 label-on-left">Proposal</label>
							<div class="col-sm-10">
								<div class="form-group">
									<a
										href="<?= base_url('pendaftaran/download_proposal/'.$PROPOSAL);?>"><?= $PROPOSAL; ?></a>
								</div>
							</div>
						</div>
						<?php if ($BUKTI == ''){
							echo '<div class="row">
							<label class="col-sm-2 label-on-left">Bukti Diterima</label>
							<div class="col-sm-10">
								<div class="form-group">
									<a>Mahasiswa belum diterima pengajuan pendaftarannya oleh tempat PKL</a>
								</div>
							</div>
						</div>';
						} else {
							...
							<div class="col-sm-10">
								<div class="form-group">
									<a href="'. base_url('pendaftaran/download_bukti/'.$BUKTI).'">'. $BUKTI.'</a>
								</div>
							</div>
						</div>';
						}?>
